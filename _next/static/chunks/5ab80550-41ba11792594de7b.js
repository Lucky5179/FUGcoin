...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [764],
  {
    50499: (t, e, r) => {
      ...
      var I = Object.defineProperty,
        ...
        _ = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        O = (t, e) => {
          for (var r in e || (e = {})) B.call(e, r) && _(t, r, e[r]);
          if (N) for (var r of N(e)) C.call(e, r) && _(t, r, e[r]);
          return t;
        };
      let R = {
      ...
      function T() {
        return k() ? R.reactNative : P() ? R.node : U() ? R.browser : R.unknown;
      }
      function D() {
        var t;
        try {
      ...
      function F() {
        return (
          (0, l.D)() || { name: "", description: "", url: "", icons: [""] }
        );
      }
      function L(t, e, i) {
        let n = (function () {
      ...
      function W(t, e) {
        return (0, h.fromMiliseconds)(
          (e || Date.now()) + (0, h.toMiliseconds)(t)
        );
      }
      function X(t) {
      ...
      async function tt({ id: t, topic: e, wcDeepLink: i }) {
        var n;
        try {
          if (!i) return;
          ...
          let s = (function (t, e, r) {
              ...
              if (t.startsWith("https://t.me")) {
                ...
                n = `${n}${e}${(function (t, e = !1) {
                  let r = M.from(t).toString("base64");
      ...
      async function te(t, e) {
        let r = "";
        try {
          if (U() && (r = localStorage.getItem(e))) return r;
          r = await t.getItem(e);
        } catch (t) {
          console.error(t);
        }
      ...
      !(function (t) {
        !(function () {
          ...
          var o = !i.JS_SHA3_NO_COMMON_JS && t.exports,
            ...
            h = [0, 8, 16, 24],
            a = [
              1, 0, 32898, 0, 32906, 0x80000000, 0x80008000, 0x80000000, 32907,
              0, 0x80000001, 0, 0x80008081, 0x80000000, 32777, 0x80000000, 138,
              0, 136, 0, 0x80008009, 0, 0x8000000a, 0, 0x8000808b, 0, 139,
              0x80000000, 32905, 0x80000000, 32771, 0x80000000, 32770,
              0x80000000, 128, 0x80000000, 32778, 0, 0x8000000a, 0x80000000,
              0x80008081, 0x80000000, 32896, 0x80000000, 0x80000001, 0,
          ...
          for (
            ...
            for (var I = w[S], N = I.bits, B = 0; B < N.length; ++B) {
              ...
              if (
                (E.push(C),
                (M[C] = I.createMethod(N[B], I.padding)),
                "sha3" !== I.name)
              ) {
                var _ = I.name + N[B];
                E.push(_), (M[_] = M[C]);
          ...
          (O.prototype.update = function (t) {
            ...
            for (
              ...
              if (this.reset)
                for (this.reset = !1, s[0] = this.block, n = 1; n < l + 1; ++n)
                  s[n] = 0;
              if (r)
                for (n = this.start; c < a && n < u; ++c)
                  s[n >> 2] |= t[c] << h[3 & n++];
              else
                for (n = this.start; c < a && n < u; ++c)
              ...
              if (((this.lastByteIndex = n), n >= u)) {
                for (this.start = n - u, this.block = s[l], n = 0; n < l; ++n)
                  d[n] ^= s[n];
                P(d), (this.reset = !0);
              } else this.start = n;
            }
            ...
            (O.prototype.toString = O.prototype.hex =
              function () {
                ...
                return (
                  n &&
                    ((u += s[((t = r[o]) >> 4) & 15] + s[15 & t]),
                    n > 1 && (u += s[(t >> 12) & 15] + s[(t >> 8) & 15]),
                    n > 2 && (u += s[(t >> 20) & 15] + s[(t >> 16) & 15])),
                  u
                );
              }),
          ...
          if (o) t.exports = M;
          else for (S = 0; S < E.length; ++S) i[E[S]] = M[E[S]];
        })();
      })(ts);
      var tu = ts.exports;
      let th = !1,
        ta = !1,
        tl = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
        tc = tl.default,
        td = null,
        tp = (function () {
          try {
      ...
      class tg {
        ...
        _log(t, e) {
          ...
          null == tl[r] &&
            ...
            tc > tl[r] || console.log.apply(console, e);
        }
        debug(...t) {
          this._log(tg.levels.DEBUG, t);
        }
        info(...t) {
          this._log(tg.levels.INFO, t);
        }
        warn(...t) {
          this._log(tg.levels.WARNING, t);
        }
        makeError(t, e, r) {
          if (ta) return this.makeError("censored error", e, {});
          e || (e = tg.errors.UNKNOWN_ERROR), r || (r = {});
          let i = [];
        ...
        throwArgumentError(t, e, r) {
          return this.throwError(t, tg.errors.INVALID_ARGUMENT, {
            argument: e,
            value: r,
          });
        }
        ...
        checkNormalize(t) {
          tp &&
            this.throwError(
              ...
              { operation: "String.prototype.normalize", form: tp }
            );
        }
        checkSafeUint53(t, e) {
          "number" == typeof t &&
            ...
            (t < 0 || t >= 0x1fffffffffffff) &&
              this.throwError(e, tg.errors.NUMERIC_FAULT, {
        ...
        checkArgumentCount(t, e, r) {
          (r = r ? ": " + r : ""),
            t < e &&
              this.throwError(
                "missing argument" + r,
                tg.errors.MISSING_ARGUMENT,
                { count: t, expectedCount: e }
              ),
            t > e &&
              this.throwError(
                "too many arguments" + r,
                tg.errors.UNEXPECTED_ARGUMENT,
                { count: t, expectedCount: e }
              );
        }
        checkNew(t, e) {
          (t === Object || null == t) &&
            this.throwError("missing new", tg.errors.MISSING_NEW, {
              name: e.name,
            });
        }
        checkAbstract(t, e) {
        ...
        static globalLogger() {
          return td || (td = new tg("logger/5.7.0")), td;
        }
        ...
        static setLogLevel(t) {
          let e = tl[t.toLowerCase()];
          if (null == e) {
            tg.globalLogger().warn("invalid log level - " + t);
            return;
          }
          tc = e;
        }
      ...
      (tg.errors = n), (tg.levels = i);
      let tv = new tg("bytes/5.7.0");
      function tb(t) {
      ...
      function tw(t) {
        ...
        if ("string" == typeof t || !ty(t.length) || t.length < 0) return !1;
        for (let e = 0; e < t.length; e++) {
          let r = t[e];
          if (!ty(r) || r < 0 || r >= 256) return !1;
        }
        return !0;
      }
      function tx(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          ...
          return 0 === e.length && e.push(0), tA(new Uint8Array(e));
        }
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : tv.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
          for (let t = 0; t < r.length; t += 2)
            i.push(parseInt(r.substring(t, t + 2), 16));
          return tA(new Uint8Array(i));
        }
        return tw(t)
          ? tA(new Uint8Array(t))
          : tv.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tM(t, e) {
        return !(
          "string" != typeof t ||
      ...
      let tE = "0123456789abcdef";
      function tS(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          tv.checkSafeUint53(t, "invalid hexlify value");
          let e = "";
          for (; t; ) (e = tE[15 & t] + e), (t = Math.floor(t / 16));
      ...
      function tI(t, e, r) {
        return (
          "string" != typeof t
            ? (t = tS(t))
            : (!tM(t) || t.length % 2) &&
              tv.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function tN(t, e) {
        for (
          "string" != typeof t
            ? (t = tS(t))
            : tM(t) || tv.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
              tv.throwArgumentError(
                "value out of range",
                "value",
                arguments[1]
              );
      ...
      function tB(t) {
        ...
        if ((tM(t) && !(t.length % 2)) || tw(t)) {
          let r = tx(t);
          64 === r.length
            ? ((e.v = 27 + (r[32] >> 7)),
              (r[32] &= 127),
              (e.r = tS(r.slice(0, 32))),
              (e.s = tS(r.slice(32, 64))))
            : 65 === r.length
            ? ((e.r = tS(r.slice(0, 32))),
              (e.s = tS(r.slice(32, 64))),
              (e.v = r[64]))
            : tv.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : tv.throwArgumentError(
          ...
          if (
            ...
            let r = (function (t, e) {
              ...
              return r.set(t, e - t.length), tA(r);
            })(tx(e._vs), 32);
            e._vs = tS(r);
            let i = r[0] >= 128 ? 1 : 0;
          ...
          let r = tx(e.s);
          r[0] >= 128 &&
            tv.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = tS(r);
          e._vs &&
            (tM(e._vs) ||
              tv.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = tN(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      !(function (t, e) {
        ...
        function s(t, e, i, n) {
          for (var o = 0, f = 0, s = Math.min(t.length, i), u = e; u < s; u++) {
            ...
            (o *= n),
              (f = h >= 49 ? h - 49 + 10 : h >= 17 ? h - 17 + 10 : h),
              r(h >= 0 && f < n, "Invalid character"),
              (o += f);
          }
          return o;
        }
          ...
          (n.prototype._initArray = function (t, e, i) {
            ...
            if ("be" === i)
              for (n = t.length - 1, o = 0; n >= 0; n -= 3)
                (f = t[n] | (t[n - 1] << 8) | (t[n - 2] << 16)),
                  (this.words[o] |= (f << s) & 0x3ffffff),
                  (this.words[o + 1] = (f >>> (26 - s)) & 0x3ffffff),
                  (s += 24) >= 26 && ((s -= 26), o++);
            else if ("le" === i)
        ...
        function p(t, e, r) {
          ...
          for (var h = 1; h < i; h++) {
            for (
              ...
              var p = (h - d) | 0;
              (a +=
                ((f = (n = 0 | t.words[p]) * (o = 0 | e.words[d]) + l) /
                  0x4000000) |
                0),
                (l = 0x3ffffff & f);
            }
        ...
        (n.prototype.toString = function (t, e) {
          ...
          (n.prototype.isub = function (t) {
            ...
            for (var o = 0, f = 0; f < r.length; f++)
              (o = (i = (0 | e.words[f]) - (0 | r.words[f]) + o) >> 26),
                (this.words[f] = 0x3ffffff & i);
            for (; 0 !== o && f < e.length; f++)
              (o = (i = (0 | e.words[f]) + o) >> 26),
                (this.words[f] = 0x3ffffff & i);
        ...
        var m = function (t, e, r) {
          ...
          (h = (((o + (n >>> 13)) | 0) + (tv >>> 26)) | 0),
            (tv &= 0x3ffffff),
            (i = Math.imul(v, z)),
            (n = ((n = Math.imul(v, j)) + Math.imul(b, z)) | 0),
            (o = Math.imul(b, j)),
            (i = (i + Math.imul(p, K)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tb >>> 26)) | 0),
            (tb &= 0x3ffffff),
            (i = Math.imul(y, z)),
            (n = ((n = Math.imul(y, j)) + Math.imul(w, z)) | 0),
            (o = Math.imul(w, j)),
            (i = (i + Math.imul(v, K)) | 0),
            (n = ((n = (n + Math.imul(v, Q)) | 0) + Math.imul(b, K)) | 0),
            (o = (o + Math.imul(b, Q)) | 0),
            (i = (i + Math.imul(p, G)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tA >>> 26)) | 0),
            (tA &= 0x3ffffff),
            (i = Math.imul(M, z)),
            (n = ((n = Math.imul(M, j)) + Math.imul(E, z)) | 0),
            (o = Math.imul(E, j)),
            (i = (i + Math.imul(y, K)) | 0),
            (n = ((n = (n + Math.imul(y, Q)) | 0) + Math.imul(w, K)) | 0),
            (o = (o + Math.imul(w, Q)) | 0),
            (i = (i + Math.imul(v, G)) | 0),
            (n = ((n = (n + Math.imul(v, Y)) | 0) + Math.imul(b, G)) | 0),
            (o = (o + Math.imul(b, Y)) | 0),
            (i = (i + Math.imul(p, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (ty >>> 26)) | 0),
            (ty &= 0x3ffffff),
            (i = Math.imul(I, z)),
            (n = ((n = Math.imul(I, j)) + Math.imul(N, z)) | 0),
            (o = Math.imul(N, j)),
            (i = (i + Math.imul(M, K)) | 0),
            (n = ((n = (n + Math.imul(M, Q)) | 0) + Math.imul(E, K)) | 0),
            (o = (o + Math.imul(E, Q)) | 0),
            (i = (i + Math.imul(y, G)) | 0),
            (n = ((n = (n + Math.imul(y, Y)) | 0) + Math.imul(w, G)) | 0),
            (o = (o + Math.imul(w, Y)) | 0),
            (i = (i + Math.imul(v, W)) | 0),
            (n = ((n = (n + Math.imul(v, X)) | 0) + Math.imul(b, W)) | 0),
            (o = (o + Math.imul(b, X)) | 0),
            (i = (i + Math.imul(p, $)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tw >>> 26)) | 0),
            ...
            (o = Math.imul(_, j)),
            (i = (i + Math.imul(I, K)) | 0),
            (n = ((n = (n + Math.imul(I, Q)) | 0) + Math.imul(N, K)) | 0),
            (o = (o + Math.imul(N, Q)) | 0),
            (i = (i + Math.imul(M, G)) | 0),
            (n = ((n = (n + Math.imul(M, Y)) | 0) + Math.imul(E, G)) | 0),
            (o = (o + Math.imul(E, Y)) | 0),
            (i = (i + Math.imul(y, W)) | 0),
            (n = ((n = (n + Math.imul(y, X)) | 0) + Math.imul(w, W)) | 0),
            (o = (o + Math.imul(w, X)) | 0),
            (i = (i + Math.imul(v, $)) | 0),
            (n = ((n = (n + Math.imul(v, tt)) | 0) + Math.imul(b, $)) | 0),
            (o = (o + Math.imul(b, tt)) | 0),
            (i = (i + Math.imul(p, tr)) | 0),
            (n = ((n = (n + Math.imul(p, ti)) | 0) + Math.imul(m, tr)) | 0),
            (o = (o + Math.imul(m, ti)) | 0),
            (i = (i + Math.imul(l, to)) | 0),
            (n = ((n = (n + Math.imul(l, tf)) | 0) + Math.imul(c, to)) | 0),
            (o = (o + Math.imul(c, tf)) | 0);
          var tx = (((h + i) | 0) + ((8191 & n) << 13)) | 0;
          (h = (((o + (n >>> 13)) | 0) + (tx >>> 26)) | 0),
            (tx &= 0x3ffffff),
            (i = Math.imul(R, z)),
            (n = ((n = Math.imul(R, j)) + Math.imul(P, z)) | 0),
            (o = Math.imul(P, j)),
            (i = (i + Math.imul(C, K)) | 0),
            (n = ((n = (n + Math.imul(C, Q)) | 0) + Math.imul(_, K)) | 0),
            (o = (o + Math.imul(_, Q)) | 0),
            (i = (i + Math.imul(I, G)) | 0),
            (n = ((n = (n + Math.imul(I, Y)) | 0) + Math.imul(N, G)) | 0),
            (o = (o + Math.imul(N, Y)) | 0),
            (i = (i + Math.imul(M, W)) | 0),
            (n = ((n = (n + Math.imul(M, X)) | 0) + Math.imul(E, W)) | 0),
            (o = (o + Math.imul(E, X)) | 0),
            (i = (i + Math.imul(y, $)) | 0),
            (n = ((n = (n + Math.imul(y, tt)) | 0) + Math.imul(w, $)) | 0),
            (o = (o + Math.imul(w, tt)) | 0),
            (i = (i + Math.imul(v, tr)) | 0),
            (n = ((n = (n + Math.imul(v, ti)) | 0) + Math.imul(b, tr)) | 0),
            (o = (o + Math.imul(b, ti)) | 0),
            (i = (i + Math.imul(p, to)) | 0),
            (n = ((n = (n + Math.imul(p, tf)) | 0) + Math.imul(m, to)) | 0),
            (o = (o + Math.imul(m, tf)) | 0),
            (i = (i + Math.imul(l, tu)) | 0),
            (n = ((n = (n + Math.imul(l, th)) | 0) + Math.imul(c, tu)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tM >>> 26)) | 0),
            ...
            (o = Math.imul(T, j)),
            (i = (i + Math.imul(R, K)) | 0),
            (n = ((n = (n + Math.imul(R, Q)) | 0) + Math.imul(P, K)) | 0),
            (o = (o + Math.imul(P, Q)) | 0),
            (i = (i + Math.imul(C, G)) | 0),
            (n = ((n = (n + Math.imul(C, Y)) | 0) + Math.imul(_, G)) | 0),
            (o = (o + Math.imul(_, Y)) | 0),
            (i = (i + Math.imul(I, W)) | 0),
            (n = ((n = (n + Math.imul(I, X)) | 0) + Math.imul(N, W)) | 0),
            (o = (o + Math.imul(N, X)) | 0),
            (i = (i + Math.imul(M, $)) | 0),
            ...
            (n = ((n = (n + Math.imul(v, tf)) | 0) + Math.imul(b, to)) | 0),
            (o = (o + Math.imul(b, tf)) | 0),
            (i = (i + Math.imul(p, tu)) | 0),
            (n = ((n = (n + Math.imul(p, th)) | 0) + Math.imul(m, tu)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tE >>> 26)) | 0),
            ...
            (o = (o + Math.imul(T, Q)) | 0),
            (i = (i + Math.imul(R, G)) | 0),
            (n = ((n = (n + Math.imul(R, Y)) | 0) + Math.imul(P, G)) | 0),
            (o = (o + Math.imul(P, Y)) | 0),
            (i = (i + Math.imul(C, W)) | 0),
            ...
            (n = ((n = (n + Math.imul(y, tf)) | 0) + Math.imul(w, to)) | 0),
            (o = (o + Math.imul(w, tf)) | 0),
            (i = (i + Math.imul(v, tu)) | 0),
            (n = ((n = (n + Math.imul(v, th)) | 0) + Math.imul(b, tu)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tS >>> 26)) | 0),
            ...
            (o = (o + Math.imul(T, Y)) | 0),
            (i = (i + Math.imul(R, W)) | 0),
            (n = ((n = (n + Math.imul(R, X)) | 0) + Math.imul(P, W)) | 0),
            (o = (o + Math.imul(P, X)) | 0),
            (i = (i + Math.imul(C, $)) | 0),
            (n = ((n = (n + Math.imul(C, tt)) | 0) + Math.imul(_, $)) | 0),
            (o = (o + Math.imul(_, tt)) | 0),
            (i = (i + Math.imul(I, tr)) | 0),
            (n = ((n = (n + Math.imul(I, ti)) | 0) + Math.imul(N, tr)) | 0),
            (o = (o + Math.imul(N, ti)) | 0),
            (i = (i + Math.imul(M, to)) | 0),
            (n = ((n = (n + Math.imul(M, tf)) | 0) + Math.imul(E, to)) | 0),
            (o = (o + Math.imul(E, tf)) | 0),
            (i = (i + Math.imul(y, tu)) | 0),
            (n = ((n = (n + Math.imul(y, th)) | 0) + Math.imul(w, tu)) | 0),
            (o = (o + Math.imul(w, th)) | 0),
            (i = (i + Math.imul(v, tl)) | 0),
            (n = ((n = (n + Math.imul(v, tc)) | 0) + Math.imul(b, tl)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tN >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(R, ti)) | 0) + Math.imul(P, tr)) | 0),
            (o = (o + Math.imul(P, ti)) | 0),
            (i = (i + Math.imul(C, to)) | 0),
            (n = ((n = (n + Math.imul(C, tf)) | 0) + Math.imul(_, to)) | 0),
            (o = (o + Math.imul(_, tf)) | 0),
            (i = (i + Math.imul(I, tu)) | 0),
            (n = ((n = (n + Math.imul(I, th)) | 0) + Math.imul(N, tu)) | 0),
            (o = (o + Math.imul(N, th)) | 0),
            (i = (i + Math.imul(M, tl)) | 0),
            (n = ((n = (n + Math.imul(M, tc)) | 0) + Math.imul(E, tl)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tB >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(R, tf)) | 0) + Math.imul(P, to)) | 0),
            (o = (o + Math.imul(P, tf)) | 0),
            (i = (i + Math.imul(C, tu)) | 0),
            (n = ((n = (n + Math.imul(C, th)) | 0) + Math.imul(_, tu)) | 0),
            (o = (o + Math.imul(_, th)) | 0),
            (i = (i + Math.imul(I, tl)) | 0),
            (n = ((n = (n + Math.imul(I, tc)) | 0) + Math.imul(N, tl)) | 0),
            (o = (o + Math.imul(N, tc)) | 0),
            (i = (i + Math.imul(M, tp)) | 0),
            (n = ((n = (n + Math.imul(M, tm)) | 0) + Math.imul(E, tp)) | 0),
            (o = (o + Math.imul(E, tm)) | 0);
          ...
          (h = (((o + (n >>> 13)) | 0) + (tC >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(U, tf)) | 0) + Math.imul(T, to)) | 0),
            (o = (o + Math.imul(T, tf)) | 0),
            (i = (i + Math.imul(R, tu)) | 0),
            (n = ((n = (n + Math.imul(R, th)) | 0) + Math.imul(P, tu)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (t_ >>> 26)) | 0),
            (t_ &= 0x3ffffff),
            (i = Math.imul(F, to)),
            (n = ((n = Math.imul(F, tf)) + Math.imul(L, to)) | 0),
            (o = Math.imul(L, tf)),
            (i = (i + Math.imul(U, tu)) | 0),
            (n = ((n = (n + Math.imul(U, th)) | 0) + Math.imul(T, tu)) | 0),
            (o = (o + Math.imul(T, th)) | 0),
            (i = (i + Math.imul(R, tl)) | 0),
            (n = ((n = (n + Math.imul(R, tc)) | 0) + Math.imul(P, tl)) | 0),
        ...
        Math.imul || (m = p),
          ...
          (n.prototype.iushrn = function (t, e, i) {
            ...
            if (0 !== f) {
              if (this.length > f)
                for (this.length -= f, u = 0; u < this.length; u++)
          ...
          (n.prototype._ishlnsubmul = function (t, e, i) {
            ...
            for (n = 0; n < t.length; n++) {
              ...
              var u = (0 | t.words[n]) * e;
              (f -= 0x3ffffff & u),
                (s = (f >> 26) - ((u / 0x4000000) | 0)),
                (this.words[n + i] = 0x3ffffff & f);
            }
            for (; n < this.length - i; n++)
              (s = (f = (0 | this.words[n + i]) + s) >> 26),
                (this.words[n + i] = 0x3ffffff & f);
            if (0 === s) return this._strip();
            for (r(-1 === s), s = 0, n = 0; n < this.length; n++)
              (s = (f = -(0 | this.words[n]) + s) >> 26),
                (this.words[n] = 0x3ffffff & f);
          ...
          (n.prototype._wordDiv = function (t, e) {
            ...
            0 != (r = 26 - this._countBits(f)) &&
              ((o = o.ushln(r)), i.iushln(r), (f = 0 | o.words[o.length - 1]));
            var s,
              u = i.length - o.length;
            if ("mod" !== e) {
            ...
            for (var l = u - 1; l >= 0; l--) {
              var c =
                (0 | i.words[o.length + l]) * 0x4000000 +
                (0 | i.words[o.length + l - 1]);
              for (
                c = Math.min((c / f) | 0, 0x3ffffff), i._ishlnsubmul(o, c, l);
                0 !== i.negative;
          ...
          (n.prototype.egcd = function (t) {
            ...
            for (
              var o = new n(1), f = new n(0), s = new n(0), u = new n(1), h = 0;
              e.isEven() && i.isEven();
              ...
              if (p > 0)
                for (i.iushrn(p); p-- > 0; )
                  (s.isOdd() || u.isOdd()) && (s.iadd(a), u.isub(l)),
                    ...
                    u.iushrn(1);
              e.cmp(i) >= 0
                ? (e.isub(i), o.isub(s), f.isub(u))
                : (i.isub(e), s.isub(o), u.isub(f));
            }
            return { a: s, b: u, gcd: i.iushln(h) };
          }),
          (n.prototype._invmp = function (t) {
            ...
            for (
              var f = new n(1), s = new n(0), u = o.clone();
      ...
      class tF {
        ...
        fromTwos(t) {
          return tq(tz(this).fromTwos(t));
        }
        toTwos(t) {
          return tq(tz(this).toTwos(t));
        }
        abs() {
          return "-" === this._hex[0] ? tF.from(this._hex.substring(1)) : this;
        }
        add(t) {
          return tq(tz(this).add(tz(t)));
        }
        sub(t) {
          return tq(tz(this).sub(tz(t)));
        }
        div(t) {
          return (
            tF.from(t).isZero() && tj("division-by-zero", "div"),
            tq(tz(this).div(tz(t)))
          );
        }
        mul(t) {
          return tq(tz(this).mul(tz(t)));
        }
        mod(t) {
          let e = tz(t);
          return (
            e.isNeg() && tj("division-by-zero", "mod"), tq(tz(this).umod(e))
          );
        }
        pow(t) {
          let e = tz(t);
          return e.isNeg() && tj("negative-power", "pow"), tq(tz(this).pow(e));
        }
        and(t) {
          let e = tz(t);
          return (
            (this.isNegative() || e.isNeg()) &&
              tj("unbound-bitwise-result", "and"),
            tq(tz(this).and(e))
          );
        }
        or(t) {
        ...
        xor(t) {
          ...
          return (
            (this.isNegative() || e.isNeg()) &&
              tj("unbound-bitwise-result", "xor"),
            tq(tz(this).xor(e))
          );
        }
        mask(t) {
          return (
            (this.isNegative() || t < 0) && tj("negative-width", "mask"),
            tq(tz(this).maskn(t))
          );
        }
        shl(t) {
          return (
            (this.isNegative() || t < 0) && tj("negative-width", "shl"),
            tq(tz(this).shln(t))
          );
        }
        shr(t) {
          return (
            (this.isNegative() || t < 0) && tj("negative-width", "shr"),
            tq(tz(this).shrn(t))
          );
        }
        eq(t) {
          return tz(this).eq(tz(t));
        }
        lt(t) {
          return tz(this).lt(tz(t));
        }
        lte(t) {
          return tz(this).lte(tz(t));
        }
        gt(t) {
          return tz(this).gt(tz(t));
        }
        gte(t) {
          return tz(this).gte(tz(t));
        }
        isNegative() {
          return "-" === this._hex[0];
        }
        isZero() {
          return tz(this).isZero();
        }
        toNumber() {
          try {
            return tz(this).toNumber();
          } catch {
            tj("overflow", "toNumber", this.toString());
          }
          return null;
        }
        toBigInt() {
        ...
        static from(t) {
          ...
          if ("string" == typeof t)
            return t.match(/^-?0x[0-9a-f]+$/i)
              ? new tF(tT, tL(t))
              : t.match(/^-?[0-9]+$/)
              ? new tF(tT, tL(new tk(t)))
              : tU.throwArgumentError("invalid BigNumber string", "value", t);
          if ("number" == typeof t)
            return (
              t % 1 && tj("underflow", "BigNumber.from", t),
              (t >= 0x1fffffffffffff || t <= -0x1fffffffffffff) &&
                tj("overflow", "BigNumber.from", t),
              tF.from(String(t))
            );
          if ("bigint" == typeof t) return tF.from(t.toString());
          if (tw(t)) return tF.from(tS(t));
          if (t) {
            if (t.toHexString) {
              let e = t.toHexString();
              if ("string" == typeof e) return tF.from(e);
            } else {
              let e = t._hex;
              if (
                (null == e && "BigNumber" === t.type && (e = t.hex),
                "string" == typeof e &&
                  (tM(e) || ("-" === e[0] && tM(e.substring(1)))))
              )
                return tF.from(e);
            }
          }
          return tU.throwArgumentError("invalid BigNumber value", "value", t);
        }
      ...
      function tL(t) {
        ...
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              tU.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = tL(t)) ? t : "-" + t
          );
      ...
      function tz(t) {
        let e = tF.from(t).toHexString();
        return "-" === e[0]
          ? new tk("-" + e.substring(3), 16)
          : new tk(e.substring(2), 16);
      }
      function tj(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r),
          tU.throwError(t, tg.errors.NUMERIC_FAULT, i)
        );
      }
      let tH = new tg(tP),
        tK = {},
      ...
      function tG(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          tH.throwError(t, tg.errors.NUMERIC_FAULT, n)
        );
      }
      let tY = "0";
      for (; tY.length < 256; ) tY += tY;
      function tV(t) {
        if ("number" != typeof t)
          try {
            t = tF.from(t).toNumber();
          } catch {}
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + tY.substring(0, t)
          : tH.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function tW(t, e) {
        null == e && (e = 0);
        let r = tV(e),
      ...
      function tX(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          tH.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && tH.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          tH.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          f = n[1];
        for (o || (o = "0"), f || (f = "0"); "0" === f[f.length - 1]; )
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || tH.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class t$ {
        ...
        addUnsafe(t) {
          this._checkFormat(t);
          let e = tX(this._value, this.format.decimals),
            r = tX(t._value, t.format.decimals);
          return t$.fromValue(e.add(r), this.format.decimals, this.format);
        }
        subUnsafe(t) {
          this._checkFormat(t);
          let e = tX(this._value, this.format.decimals),
            r = tX(t._value, t.format.decimals);
          return t$.fromValue(e.sub(r), this.format.decimals, this.format);
        }
        mulUnsafe(t) {
          this._checkFormat(t);
          let e = tX(this._value, this.format.decimals),
        ...
        floor() {
          ...
          1 === t.length && t.push("0");
          let e = t$.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(t0.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = t$.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(t0.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              tH.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
          let r = t$.from("1" + tY.substring(0, t), this.format),
            i = t1.toFormat(this.format);
        ...
        toHexString(t) {
          return null == t
            ? this._hex
            : (t % 8 && tH.throwArgumentError("invalid byte width", "width", t),
              tN(
                tF
                  .from(this._hex)
        ...
        toFormat(t) {
          return t$.fromString(this._value, t);
        }
        ...
        static fromString(t, e) {
          ...
          !r.signed &&
            i.lt(tQ) &&
            tG("unsigned value cannot be negative", "overflow", "value", t);
          let n = null;
          return new t$(
            tK,
            r.signed
              ? i.toTwos(r.width).toHexString()
              : tN(i.toHexString(), r.width / 8),
            tW(i, r.decimals),
            r
          );
        }
        static fromBytes(t, e) {
          null == e && (e = "fixed");
          let r = tZ.from(e);
          if (tx(t).length > r.width / 8) throw Error("overflow");
          let i = tF.from(t);
          return (
        ...
        static from(t, e) {
          if ("string" == typeof t) return t$.fromString(t, e);
          if (tw(t)) return t$.fromBytes(t, e);
          try {
            return t$.fromValue(t, 0, e);
          } catch (t) {
            if (t.code !== tg.errors.INVALID_ARGUMENT) throw t;
          }
          return tH.throwArgumentError("invalid FixedNumber value", "value", t);
        }
      ...
      let t0 = t$.from(1),
        t1 = t$.from("0.5"),
        t2 = new tg("strings/5.7.0");
      function t3(t, e, r, i, n) {
      ...
      function t6(t, e = o.current) {
        e != o.current && (t2.checkNormalize(), (t = t.normalize(e)));
        let r = [];
        for (let e = 0; e < t.length; e++) {
            ...
            for (;;) {
              ...
              for (; !((f ^ s) & 0x40000000); )
                (l = ((l << 1) & 0x7fffffff) | a()),
                  ...
                  (s = ((s << 1) & 0x7fffffff) | 1);
              for (; f & ~s & 0x20000000; )
                (l = (0x40000000 & l) | ((l << 1) & 0x3fffffff) | a()),
                  (f = (f << 1) ^ 0x40000000),
      ...
      et(er),
        ...
        (function (t) {
          ...
          for (;;) {
            let r = t() - 1;
            if (r < 0) break;
            e.push(ee(1 + t(), 1 + r, t).map((t) => [t[0], t.slice(1)]));
          }
          (function (t) {
            let e = {};
            for (let r = 0; r < t.length; r++) {
      ...
      let ei = `Ethereum Signed Message:
`;
      function en(t) {
        return (
          "string" == typeof t && (t = t6(t)),
          tC(
            (function (t) {
              let e = t.map((t) => tx(t)),
                r = new Uint8Array(e.reduce((t, e) => t + e.length, 0));
              return e.reduce((t, e) => (r.set(e, t), t + e.length), 0), tA(r);
            })([t6(ei), t6(String(t.length)), t])
          )
        );
      }
      new tg("rlp/5.7.0");
      let eo = new tg("address/5.7.0");
      function ef(t) {
        tM(t, 20) || eo.throwArgumentError("invalid address", "address", t);
      ...
      let es = {};
      for (let t = 0; t < 10; t++) es[String(t)] = String(t);
      for (let t = 0; t < 26; t++)
        es[String.fromCharCode(65 + t)] = String(10 + t);
      let eu = Math.floor(
        Math.log10
      ...
      tF.from(
        ...
        tN(el.toHexString(), 32),
        tN(ea.toHexString(), 32);
      var ec = {},
        ed = {};
      function ep(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
      ep.equal = function (t, e, r) {
        if (t != e) throw Error(r || "Assertion failed: " + t + " != " + e);
      };
      var em = { exports: {} };
      "function" == typeof Object.create
        ? (em.exports = function (t, e) {
            e &&
              ((t.super_ = e),
      ...
      (ed.inherits = eg),
              ...
              for (var i = 0, n = 0; n < t.length; n++) {
                ...
                s < 128
                  ...
                  : (s < 2048
                      ...
                      : (((o = t),
                        (f = n),
                        (64512 & o.charCodeAt(f)) != 55296 ||
                          f < 0 ||
                          f + 1 >= o.length ||
                          (64512 & o.charCodeAt(f + 1)) != 56320)
                          ? (r[i++] = (s >> 12) | 224)
                          : ((s =
                              65536 +
                              ((1023 & s) << 10) +
        ...
        (ed.htonl = ev),
        (ed.toHex32 = function (t, e) {
          for (var r = "", i = 0; i < t.length; i++) {
            var n = t[i];
            "little" === e && (n = ev(n)), (r += eA(n.toString(16)));
          }
          return r;
        }),
        (ed.zero2 = eb),
        (ed.zero8 = eA),
        (ed.join32 = function (t, e, r, i) {
          var n,
            o = r - e;
          ep(o % 4 == 0);
          for (var f = Array(o / 4), s = 0, u = e; s < f.length; s++, u += 4)
            (n =
              "big" === i
        ...
        (ed.rotr32 = function (t, e) {
          return (t >>> e) | (t << (32 - e));
        }),
        (ed.rotl32 = function (t, e) {
          return (t << e) | (t >>> (32 - e));
        }),
        (ed.sum32 = function (t, e) {
          return (t + e) >>> 0;
        }),
        (ed.sum32_3 = function (t, e, r) {
          return (t + e + r) >>> 0;
        }),
        (ed.sum32_4 = function (t, e, r, i) {
          return (t + e + r + i) >>> 0;
        }),
        (ed.sum32_5 = function (t, e, r, i, n) {
          return (t + e + r + i + n) >>> 0;
        }),
        (ed.sum64 = function (t, e, r, i) {
          var n = t[e],
            o = (i + t[e + 1]) >>> 0;
          (t[e] = ((o < i ? 1 : 0) + r + n) >>> 0), (t[e + 1] = o);
        }),
        (ed.sum64_hi = function (t, e, r, i) {
          return (((e + i) >>> 0 < e ? 1 : 0) + t + r) >>> 0;
        }),
        (ed.sum64_lo = function (t, e, r, i) {
          return (e + i) >>> 0;
        }),
        (ed.sum64_4_hi = function (t, e, r, i, n, o, f, s) {
          var u,
            h = e;
          return (
            (t +
        ...
        (ed.sum64_4_lo = function (t, e, r, i, n, o, f, s) {
          return (e + i + o + s) >>> 0;
        }),
        (ed.sum64_5_hi = function (t, e, r, i, n, o, f, s, u, h) {
          var a,
            l = e;
          return (
            (t +
        ...
        (ed.sum64_5_lo = function (t, e, r, i, n, o, f, s, u, h) {
          return (e + i + o + s + h) >>> 0;
        }),
        (ed.rotr64_hi = function (t, e, r) {
          return ((e << (32 - r)) | (t >>> r)) >>> 0;
        }),
        (ed.rotr64_lo = function (t, e, r) {
          return ((t << (32 - r)) | (e >>> r)) >>> 0;
        }),
        (ed.shr64_hi = function (t, e, r) {
          return t >>> r;
        }),
        (ed.shr64_lo = function (t, e, r) {
          return ((t << (32 - r)) | (e >>> r)) >>> 0;
        });
      var ey = {};
      function ew() {
      ...
      (ey.BlockHash = ew),
        (ew.prototype.update = function (t, e) {
          if (
            ((t = ed.toArray(t, e)),
            this.pending
            ...
            (this.pending = t.slice(t.length - r, t.length)),
              ...
              (t = ed.join32(t, 0, t.length - r, this.endian));
            for (var i = 0; i < t.length; i += this._delta32)
              this._update(t, i, i + this._delta32);
          }
          return this;
        }),
        (ew.prototype.digest = function (t) {
          return (
            this.update(this._pad()), ep(null === this.pending), this._digest(t)
          );
        }),
        (ew.prototype._pad = function () {
      ...
      (eM.ft_1 = function (t, e, r, i) {
        ...
        (eM.ch32 = function (t, e, r) {
          return (t & e) ^ (~t & r);
        }),
        (eM.maj32 = eS),
        (eM.p32 = function (t, e, r) {
          return t ^ e ^ r;
        }),
        (eM.s0_256 = function (t) {
          return eE(t, 2) ^ eE(t, 13) ^ eE(t, 22);
        }),
        (eM.s1_256 = function (t) {
          return eE(t, 6) ^ eE(t, 11) ^ eE(t, 25);
        }),
        (eM.g0_256 = function (t) {
          return eE(t, 7) ^ eE(t, 18) ^ (t >>> 3);
        }),
        (eM.g1_256 = function (t) {
          return eE(t, 17) ^ eE(t, 19) ^ (t >>> 10);
        });
      var eI = ed.rotl32,
        eN = ed.sum32,
        eB = ed.sum32_5,
        eC = eM.ft_1,
        e_ = ey.BlockHash,
        eO = [0x5a827999, 0x6ed9eba1, 0x8f1bbcdc, 0xca62c1d6];
      function eR() {
      ...
      ed.inherits(eR, e_),
        ...
        (eR.prototype._update = function (t, e) {
          ...
          for (; i < r.length; i++)
            r[i] = eI(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
          var n = this.h[0],
            o = this.h[1],
            f = this.h[2],
            s = this.h[3],
          ...
          for (i = 0; i < r.length; i++) {
            var h = ~~(i / 20),
              a = eB(eI(n, 5), eC(h, o, f, s), u, r[i], eO[h]);
            (u = s), (s = f), (f = eI(o, 30)), (o = n), (n = a);
          }
          (this.h[0] = eN(this.h[0], n)),
            (this.h[1] = eN(this.h[1], o)),
            (this.h[2] = eN(this.h[2], f)),
            (this.h[3] = eN(this.h[3], s)),
            (this.h[4] = eN(this.h[4], u));
        }),
        (eR.prototype._digest = function (t) {
          return "hex" === t
            ? ed.toHex32(this.h, "big")
      ...
      ed.inherits(eK, ej),
        ...
        (eK.hmacStrength = 192),
        (eK.padLength = 64),
        (eK.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = ek(ez(r[i - 2]), r[i - 7], eq(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            f = this.h[2],
            s = this.h[3],
            ...
            a = this.h[6],
            l = this.h[7];
          for (ep(this.k.length === r.length), i = 0; i < r.length; i++) {
            var c = eU(l, eL(u), eT(u, h, a), this.k[i], r[i]),
              d = eP(eF(n), eD(n, o, f));
            (l = a),
              (a = h),
              (h = u),
          ...
          (this.h[0] = eP(this.h[0], n)),
            (this.h[1] = eP(this.h[1], o)),
            (this.h[2] = eP(this.h[2], f)),
            (this.h[3] = eP(this.h[3], s)),
            (this.h[4] = eP(this.h[4], u)),
            (this.h[5] = eP(this.h[5], h)),
            (this.h[6] = eP(this.h[6], a)),
            (this.h[7] = eP(this.h[7], l));
        }),
        ...
        (eQ.prototype._digest = function (t) {
          return "hex" === t
            ? ed.toHex32(this.h.slice(0, 7), "big")
            : ed.split32(this.h.slice(0, 7), "big");
        });
      var eJ = ed.rotr64_hi,
        eG = ed.rotr64_lo,
        eY = ed.shr64_hi,
      ...
      function e8() {
        if (!(this instanceof e8)) return new e8();
        e3.call(this),
          (this.h = [
      ...
      ed.inherits(e8, e3),
        ...
        (e8.hmacStrength = 192),
        (e8.padLength = 128),
        (e8.prototype._prepareBlock = function (t, e) {
          for (var r = this.W, i = 0; i < 32; i++) r[i] = t[e + i];
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
                var r = eJ(t, e, 19) ^ eJ(e, t, 29) ^ eY(t, e, 6);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 4], r[i - 3]),
              o = (function (t, e) {
                var r = eG(t, e, 19) ^ eG(e, t, 29) ^ eV(t, e, 6);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 4], r[i - 3]),
              f = r[i - 14],
              s = r[i - 13],
              u = (function (t, e) {
                var r = eJ(t, e, 1) ^ eJ(t, e, 8) ^ eY(t, e, 7);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 30], r[i - 29]),
              h = (function (t, e) {
                var r = eG(t, e, 1) ^ eG(t, e, 8) ^ eV(t, e, 7);
                return r < 0 && (r += 0x100000000), r;
              })(r[i - 30], r[i - 29]),
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = e$(n, o, f, s, u, h, a, l)),
              (r[i + 1] = e0(n, o, f, s, u, h, a, l));
          }
        }),
        (e8.prototype._update = function (t, e) {
          ...
          for (var A = 0; A < r.length; A += 2) {
            var y = v,
              ...
              M = (function (t, e) {
                var r = eG(t, e, 14) ^ eG(t, e, 18) ^ eG(e, t, 9);
                return r < 0 && (r += 0x100000000), r;
              })(l, c),
              ...
              B = r[A],
              C = r[A + 1],
              _ = e1(y, w, x, M, E, S, I, N, B, C),
              O = e2(y, w, x, M, E, S, I, N, B, C);
            y = (function (t, e) {
            ...
            var R = eX(
                y,
                (w = (function (t, e) {
                  var r = eG(t, e, 28) ^ eG(e, t, 2) ^ eG(e, t, 7);
                  return r < 0 && (r += 0x100000000), r;
                })(i, n)),
        ...
        (e8.prototype._digest = function (t) {
          return "hex" === t
            ? ed.toHex32(this.h, "big")
            : ed.split32(this.h, "big");
        }),
        ...
        (e5.prototype._digest = function (t) {
          return "hex" === t
            ? ed.toHex32(this.h.slice(0, 12), "big")
            : ed.split32(this.h.slice(0, 12), "big");
        }),
        (ex.sha1 = eR),
        (ex.sha224 = eQ),
        (ex.sha256 = eK),
      ...
      ed.inherits(ri, rr),
        ...
        (ri.hmacStrength = 192),
        (ri.padLength = 64),
        (ri.prototype._update = function (t, e) {
          for (
            var r = this.h[0],
              i = this.h[1],
              n = this.h[2],
          ...
          (m = rt(this.h[1], n, a)),
            (this.h[1] = rt(this.h[2], o, l)),
            (this.h[2] = rt(this.h[3], f, s)),
            (this.h[3] = rt(this.h[4], r, u)),
            (this.h[4] = rt(this.h[0], i, h)),
            (this.h[0] = m);
        }),
        (ri.prototype._digest = function (t) {
          return "hex" === t
            ? ed.toHex32(this.h, "little")
            : ed.split32(this.h, "little");
        });
      var ro = [
      ...
      function rh(t, e, r) {
        if (!(this instanceof rh)) return new rh(t, e, r);
        (this.Hash = t),
          (this.blockSize = t.blockSize / 8),
          (this.outSize = t.outSize / 8),
          (this.inner = null),
          (this.outer = null),
          this._init(ed.toArray(e, r));
      }
      function ra(t, e, r) {
        return (
          t(
      ...
      (rh.prototype._init = function (t) {
        t.length > this.blockSize && (t = new this.Hash().update(t).digest()),
          ep(t.length <= this.blockSize);
        ...
        (rh.prototype.digest = function (t) {
      ...
      rc.equal = function (t, e, r) {
        if (t != e) throw Error(r || "Assertion failed: " + t + " != " + e);
      };
      var rd = ra(function (t, e) {
          function r(t) {
            return 1 === t.length ? "0" + t : t;
          }
          function i(t) {
      ...
      function rb(t, e) {
        (this.type = t),
          (this.p = new tR(e.p, 16)),
          (this.red = e.prime ? tR.red(e.prime) : tR.mont(this.p)),
          (this.zero = new tR(0).toRed(this.red)),
          (this.one = new tR(1).toRed(this.red)),
          (this.two = new tR(2).toRed(this.red)),
          (this.n = e.n && new tR(e.n, 16)),
      ...
      (rb.prototype.point = function () {
          ...
          for (
            ...
            for (o = 0; o < s.length; o++)
              (f = s[o]) === l
                ...
                : f === -l && (a = a.mixedAdd(r.points[o].neg()));
            h = h.add(a);
          }
          return h.toP();
        }),
        ...
        (rb.prototype._wnafMulAdd = function (t, e, r, i, n) {
          ...
          for (o = i - 1; o >= 1; o -= 2) {
            var d = o - 1,
              p = o;
            if (1 !== u[d] || 1 !== u[p]) {
              (a[d] = rm(r[d], u[d], this._bitLength)),
                (a[p] = rm(r[p], u[p], this._bitLength)),
        ...
        (rA.prototype.encodeCompressed = function (t) {
          return this.encode(t, !0);
        }),
        (rA.prototype._encode = function (t) {
        ...
        (rA.prototype.encode = function (t, e) {
          return rp.encode(this._encode(e), t);
        }),
        (rA.prototype.precompute = function (t) {
        ...
        (rA.prototype._hasDoubles = function (t) {
        ...
        (rA.prototype._getDoubles = function (t, e) {
        ...
        (rA.prototype._getNAFPoints = function (t) {
        ...
        (rA.prototype._getBeta = function () {
          return null;
        }),
        (rA.prototype.dblp = function (t) {
          for (var e = this, r = 0; r < t; r++) e = e.dbl();
          return e;
        });
      var ry = ra(function (t) {
          "function" == typeof Object.create
      ...
      function rx(t) {
        rb.call(this, "short", t),
          (this.a = new tR(t.a, 16).toRed(this.red)),
          (this.b = new tR(t.b, 16).toRed(this.red)),
      ...
      ry(rx, rb),
        (rx.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            if (t.beta) e = new tR(t.beta, 16).toRed(this.red);
            else {
              var e,
                r,
                i,
            ...
            if (t.lambda) r = new tR(t.lambda, 16);
            else {
              var o = this._getEndoRoots(this.n);
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  rw(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new tR(t.a, 16), b: new tR(t.b, 16) };
                  })
        ...
        (rx.prototype._getEndoRoots = function (t) {
          var e = t === this.p ? this.red : tR.mont(t),
            r = new tR(2).toRed(e).redInvm(),
            i = r.redNeg(),
            n = new tR(3).toRed(e).redNeg().redSqrt().redMul(r);
          return [i.redAdd(n).fromRed(), i.redSub(n).fromRed()];
        }),
        (rx.prototype._getEndoBasis = function (t) {
          for (
            var e,
              r,
              i,
          ...
          return (
            o.sqr().add(f.sqr()).cmp(y) >= 0 && ((o = e), (f = r)),
        ...
        (rx.prototype._endoSplit = function (t) {
          var e = this.endo.basis,
            ...
            u = n.mul(r.b),
            h = o.mul(i.b);
          return { k1: t.sub(f).sub(s), k2: u.add(h).neg() };
        }),
        (rx.prototype.pointFromX = function (t, e) {
          (t = new tR(t, 16)).red || (t = t.toRed(this.red));
          var r = t
              .redSqr()
              .redMul(t)
        ...
        (rx.prototype.validate = function (t) {
          if (t.inf) return !0;
          var e = t.x,
            r = t.y,
            i = this.a.redMul(e),
        ...
        (rx.prototype._endoWnafMulAdd = function (t, e, r) {
          for (
        ...
        ry(rM, rb.BasePoint),
        (rx.prototype.point = function (t, e, r) {
          return new rM(this, t, e, r);
        }),
        (rx.prototype.pointFromJSON = function (t, e) {
          return rM.fromJSON(this, t, e);
        }),
        (rM.prototype._getBeta = function () {
          if (this.curve.endo) {
        ...
        (rM.prototype.isInfinity = function () {
          return this.inf;
        }),
        ...
        (rM.prototype.getX = function () {
          return this.x.fromRed();
        }),
        (rM.prototype.getY = function () {
          return this.y.fromRed();
        }),
        (rM.prototype.mul = function (t) {
          return (
            (t = new tR(t, 16)),
            this.isInfinity()
              ? this
        ...
        (rM.prototype.mulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
        ...
        (rM.prototype.jmulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
          return this.curve.endo
        ...
        (rM.prototype.toJ = function () {
          return this.inf
            ? this.curve.jpoint(null, null, null)
            : this.curve.jpoint(this.x, this.y, this.curve.one);
        }),
        ry(rE, rb.BasePoint),
        (rx.prototype.jpoint = function (t, e, r) {
        ...
        (rE.prototype.mixedAdd = function (t) {
        ...
        (rE.prototype._zeroDbl = function () {
          ...
          if (this.zOne) {
            ...
            (h = (h = h.redIAdd(h)).redIAdd(h)),
              (t = u),
              (e = s.redMul(f.redISub(u)).redISub(h)),
        ...
        (rE.prototype.trpl = function () {
          ...
          var t = this.x.redSqr(),
            ...
            s = (f = (f = (f = f.redIAdd(f)).redAdd(f).redIAdd(f)).redISub(
              o
            )).redSqr(),
            u = i.redIAdd(i);
        ...
        (rE.prototype.mul = function (t, e) {
          return (t = new tR(t, e)), this.curve._wnafMul(this, t);
        }),
      ...
      var rS = ra(function (t, e) {
          (e.base = rb), (e.short = rx), (e.mont = null), (e.edwards = null);
        }),
        rI = ra(function (t, e) {
          var r,
            i = rp.assert;
          function n(t) {
            "short" === t.type
              ? (this.curve = new rS.short(t))
              : "edwards" === t.type
              ? (this.curve = new rS.edwards(t))
              : (this.curve = new rS.mont(t)),
              (this.g = this.curve.g),
              (this.n = this.curve.n),
              (this.hash = t.hash),
      ...
      function rN(t) {
        if (!(this instanceof rN)) return new rN(t);
        (this.hash = t.hash),
          ...
          (this.K = null),
          (this.V = null);
        var e = rd.toArray(t.entropy, t.entropyEnc || "hex"),
          r = rd.toArray(t.nonce, t.nonceEnc || "hex"),
          i = rd.toArray(t.pers, t.persEnc || "hex");
        rl(
      ...
      (rN.prototype._init = function (t, e, r) {
        ...
        (rN.prototype.reseed = function (t, e, r, i) {
        ...
        (rN.prototype.generate = function (t, e, r, i) {
          if (this._reseed > this.reseedInterval)
            throw Error("Reseed is required");
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = rd.toArray(r, i || "hex")), this._update(r));
          for (var n = []; n.length < t; )
            (this.V = this._hmac().update(this.V).digest()),
              (n = n.concat(this.V));
          var o = n.slice(0, t);
          return this._update(r), this._reseed++, rd.encode(o, e);
        });
      var rB = rp.assert;
      function rC(t, e) {
        (this.ec = t),
      ...
      (rC.fromPublic = function (t, e, r) {
        return e instanceof rC ? e : new rC(t, { pub: e, pubEnc: r });
      }),
        (rC.fromPrivate = function (t, e, r) {
          return e instanceof rC ? e : new rC(t, { priv: e, privEnc: r });
        }),
        ...
        (rC.prototype.getPublic = function (t, e) {
          return (
        ...
        (rC.prototype.getPrivate = function (t) {
          return "hex" === t ? this.priv.toString(16, 2) : this.priv;
        }),
        (rC.prototype._importPrivate = function (t, e) {
          (this.priv = new tR(t, e || 16)),
            (this.priv = this.priv.umod(this.ec.curve.n));
        }),
        (rC.prototype._importPublic = function (t, e) {
          if (t.x || t.y) {
            "mont" === this.ec.curve.type
              ? rB(t.x, "Need x coordinate")
              : ("short" === this.ec.curve.type ||
                  "edwards" === this.ec.curve.type) &&
                rB(t.x && t.y, "Need both x and y coordinate"),
              (this.pub = this.ec.curve.point(t.x, t.y));
            return;
          }
          this.pub = this.ec.curve.decodePoint(t, e);
        }),
        (rC.prototype.derive = function (t) {
          return (
            t.validate() || rB(t.validate(), "public point not validated"),
            t.mul(this.priv).getX()
          );
        }),
        (rC.prototype.sign = function (t, e, r) {
          return this.ec.sign(t, this, e, r);
        }),
        (rC.prototype.verify = function (t, e) {
      ...
      function rO(t, e) {
        ...
        this._importDER(t, e) ||
          (r_(t.r && t.s, "Signature without r or s"),
          (this.r = new tR(t.r, 16)),
          (this.s = new tR(t.s, 16)),
      ...
      function rP(t, e) {
        ...
        var i = 15 & r;
        if (0 === i || i > 4) return !1;
        for (var n = 0, o = 0, f = e.place; o < i; o++, f++)
          (n <<= 8), (n |= t[f]), (n >>>= 0);
      ...
      (rO.prototype._importDER = function (t, e) {
        ...
        (rO.prototype.toDER = function (t) {
          ...
          for (
            ...
            r = r.slice(1);
          var i = [2];
          rU(i, e.length), (i = i.concat(e)).push(2), rU(i, r.length);
          var n = i.concat(r),
            o = [48];
          return rU(o, n.length), (o = o.concat(n)), rp.encode(o, t);
        });
      var rT = function () {
        ...
        rD = rp.assert;
      function rF(t) {
        if (!(this instanceof rF)) return new rF(t);
        "string" == typeof t &&
          (rD(
            Object.prototype.hasOwnProperty.call(rI, t),
            "Unknown curve " + t
          ),
          (t = rI[t])),
          t instanceof rI.PresetCurve && (t = { curve: t }),
      ...
      (rF.prototype.keyPair = function (t) {
        return new rC(this, t);
      }),
        (rF.prototype.keyFromPrivate = function (t, e) {
          return rC.fromPrivate(this, t, e);
        }),
        (rF.prototype.keyFromPublic = function (t, e) {
          return rC.fromPublic(this, t, e);
        }),
        (rF.prototype.genKeyPair = function (t) {
          t || (t = {});
          for (
            var e = new rN({
                hash: this.hash,
                ...
                entropy: t.entropy || rT(this.hash.hmacStrength),
                entropyEnc: (t.entropy && t.entropyEnc) || "utf8",
                nonce: this.n.toArray(),
              }),
              r = this.n.byteLength(),
              i = this.n.sub(new tR(2));
            ;

          ) {
            var n = new tR(e.generate(r));
            if (!(n.cmp(i) > 0)) return n.iaddn(1), this.keyFromPrivate(n);
          }
        }),
        (rF.prototype._truncateToN = function (t, e) {
        ...
        (rF.prototype.sign = function (t, e, r, i) {
          "object" == typeof r && ((i = r), (r = null)),
            i || (i = {}),
            (e = this.keyFromPrivate(e, r)),
            (t = this._truncateToN(new tR(t, 16)));
          for (
            var n = this.n.byteLength(),
              ...
              u = this.n.sub(new tR(1)),
              h = 0;
            ;
            h++
          ) {
            var a = i.k ? i.k(h) : new tR(s.generate(this.n.byteLength()));
            if (
              !(0 >= (a = this._truncateToN(a, !0)).cmpn(1) || a.cmp(u) >= 0)
            ) {
              var l = this.g.mul(a);
              if (!l.isInfinity()) {
                var c = l.getX(),
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    ...
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rO({ r: d, s: p, recoveryParam: m })
                    );
                  }
                }
              }
        ...
        (rF.prototype.verify = function (t, e, r, i) {
          (t = this._truncateToN(new tR(t, 16))),
            (r = this.keyFromPublic(r, i));
          var n = (e = new rO(e, "hex")).r,
            o = e.s;
          if (
            0 > n.cmpn(1) ||
            n.cmp(this.n) >= 0 ||
          ...
          return this.curve._maxwellTrick
            ? !(f = this.g.jmulAdd(u, r.getPublic(), h)).isInfinity() &&
                f.eqXToP(n)
            : !(f = this.g.mulAdd(u, r.getPublic(), h)).isInfinity() &&
                0 === f.getX().umod(this.n).cmp(n);
        }),
        (rF.prototype.recoverPubKey = function (t, e, r, i) {
          rD((3 & r) === r, "The recovery param is more than two bits"),
            (e = new rO(e, i));
          var n = this.n,
            o = new tR(t),
            f = e.r,
        ...
        (rF.prototype.getKeyRecoveryParam = function (t, e, r, i) {
          if (null !== (e = new rO(e, i)).recoveryParam) return e.recoveryParam;
          for (var n, o = 0; o < 4; o++) {
            try {
      ...
      let rq = new tg("signing-key/5.7.0"),
        rz = null;
      function rj() {
        return rz || (rz = new rL("secp256k1")), rz;
      }
      class rH {
        constructor(t) {
          eh(this, "curve", "secp256k1"),
            eh(this, "privateKey", tS(t)),
            32 !==
              (function (t) {
                if ("string" != typeof t) t = tS(t);
                else if (!tM(t) || t.length % 2) return null;
                return (t.length - 2) / 2;
              })(this.privateKey) &&
          ...
          let e = rj().keyFromPrivate(tx(this.privateKey));
          eh(this, "publicKey", "0x" + e.getPublic(!1, "hex")),
            eh(this, "compressedPublicKey", "0x" + e.getPublic(!0, "hex")),
            eh(this, "_isSigningKey", !0);
        }
        _addPoint(t) {
          let e = rj().keyFromPublic(tx(this.publicKey)),
            r = rj().keyFromPublic(tx(t));
        ...
        signDigest(t) {
          ...
          return tB({
            ...
            r: tN("0x" + i.r.toString(16), 32),
            s: tN("0x" + i.s.toString(16), 32),
          });
        }
        computeSharedSecret(t) {
          let e = rj().keyFromPrivate(tx(this.privateKey)),
            r = rj().keyFromPublic(tx(rK(t)));
          return tN("0x" + e.derive(r.getPublic()).toString(16), 32);
        }
      ...
      function rK(t, e) {
        ...
        if (32 === r.length) {
          let t = new rH(r);
          return e
            ? "0x" + rj().keyFromPrivate(r).getPublic(!0, "hex")
            : t.publicKey;
        }
        return 33 === r.length
          ? e
            ? tS(r)
            : "0x" + rj().keyFromPublic(r).getPublic(!1, "hex")
          : 65 === r.length
          ? e
            ? "0x" + rj().keyFromPublic(r).getPublic(!0, "hex")
            : tS(r)
          : rq.throwArgumentError(
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t) {
                ...
                if (
                  ("string" != typeof t &&
                    eo.throwArgumentError("invalid address", "address", t),
                  ...
                  for (
                    t.substring(2, 4) !==
                      ...
                      eo.throwArgumentError("bad icap checksum", "address", t),
                      e = new tk(t.substring(4), 36).toString(16);
                    e.length < 40;

                  )
                    e = "0" + e;
                  e = ef("0x" + e);
                } else eo.throwArgumentError("invalid address", "address", t);
                return e;
              })(
                tI(
                  tC(
                      ...
                      rK(
                        (function (t, e) {
                          ...
                          return (
                            "0x" +
                            rj()
                              .recoverPubKey(tx(t), i, r.recoveryParam)
                              .encode("hex", !1)
                          );
                        })(tx(en(e)), f)
                      ),
      ...
      var rG = Object.defineProperty,
        ...
        rV = Object.getOwnPropertyDescriptors,
        ...
        r$ = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        r0 = (t, e) => {
          for (var r in e || (e = {})) rX.call(e, r) && r$(t, r, e[r]);
          if (rW) for (var r of rW(e)) rZ.call(e, r) && r$(t, r, e[r]);
          return t;
        },
        r1 = (t, e) => rY(t, rV(e));
      let r2 = (t) => t?.split(":"),
      ...
      async function r5(t) {
        let { cacao: e, projectId: r } = t,
          ...
          o = r4(n, n.iss),
          f = r8(n.iss);
        return await rQ(f, o, i, r3(n.iss), r);
      }
      let r4 = (t, e) => {
...
- ${t}`
        ...
        return (
          ...
          [r, i, "", n, "", o, f, s, u, h, a, l, c, d].filter((t) => null != t)
            .join(`
`)
        );
      };
      ...
      function r7(t) {
        return (
          r9(t),
          `urn:recap:${M.from(JSON.stringify(t))
            .toString("base64")
            .replace(/=/g, "")}`
        );
      }
      function it(t) {
        ...
        let r =
          ...
          JSON.parse(M.from(e, "base64").toString("utf-8")));
        return r9(r), r;
      }
      function ie(t, e, r) {
        return r7(
            ...
            return (
              r.forEach((r) => {
                ...
                Object.keys((null == (n = t.att) ? void 0 : n[r]) || {})
                  ...
                  .forEach((n) => {
                    var o, f;
                    i.att[r] = r1(r0({}, i.att[r]), {
                      [n]:
                        (null == (o = t.att[r]) ? void 0 : o[n]) ||
                        (null == (f = e.att[r]) ? void 0 : f[n]),
                    });
                  });
              }),
              i
      ...
      function im() {
        let t = v.Au();
        return {
          privateKey: (0, b.BB)(t.secretKey, ih),
          publicKey: (0, b.BB)(t.publicKey, ih),
        };
      }
      function ig() {
      ...
      function iv(t, e) {
        let r = v.gi((0, b.mL)(t, ih), (0, b.mL)(e, ih), !0),
          i = new p.t(g.mE, r).expand(32);
        return (0, b.BB)(i, ih);
      }
      function ib(t) {
        let e = (0, g.vp)((0, b.mL)(t, ih));
        return (0, b.BB)(e, ih);
      }
      function iA(t) {
        let e = (0, g.vp)((0, b.mL)(t, ic));
        return (0, b.BB)(e, ih);
      }
      function iy(t) {
        return (0, b.mL)(`${t}`, iu);
      ...
      function iw(t) {
        return Number((0, b.BB)(t, iu));
      }
      function ix(t) {
        let e = iy("u" > typeof t.type ? t.type : 0);
        if (iw(e) === id && typeof t.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let r =
            "u" > typeof t.senderPublicKey
              ? (0, b.mL)(t.senderPublicKey, ih)
              : void 0,
          i = "u" > typeof t.iv ? (0, b.mL)(t.iv, ih) : (0, m.randomBytes)(12);
        return iI({
          type: e,
          sealed: new d.OK((0, b.mL)(t.symKey, ih)).seal(
            i,
            (0, b.mL)(t.message, ic)
          ),
          iv: i,
      ...
      function iM(t, e) {
        ...
        return iI({ type: r, sealed: (0, b.mL)(t, ic), iv: i, encoding: e });
      }
      function iE(t) {
        let e = new d.OK((0, b.mL)(t.symKey, ih)),
          { sealed: r, iv: i } = iN({
            encoded: t.encoded,
            encoding: t?.encoding,
          }),
      ...
      function iS(t, e) {
        let { sealed: r } = iN({ encoded: t, encoding: e });
        return (0, b.BB)(r, ic);
      }
      function iI(t) {
        let { encoding: e = ia } = t;
        if (iw(t.type) === ip)
          return (0, b.BB)((0, b.zo)([t.type, t.sealed]), e);
        if (iw(t.type) === id) {
          if (typeof t.senderPublicKey > "u")
            throw Error("Missing sender public key for type 1 envelope");
          return (0, b.BB)(
            (0, b.zo)([t.type, t.senderPublicKey, t.iv, t.sealed]),
            e
          );
        }
        return (0, b.BB)((0, b.zo)([t.type, t.iv, t.sealed]), e);
      }
      function iN(t) {
        let { encoded: e, encoding: r = ia } = t,
          i = (0, b.mL)(e, r),
          n = i.slice(0, 1);
        if (iw(n) === id) {
          let t = i.slice(1, 33),
        ...
        if (iw(n) === ip)
          return { type: n, sealed: i.slice(1), iv: (0, m.randomBytes)(12) };
        let o = i.slice(1, 13);
        return { type: n, sealed: i.slice(13), iv: o };
      }
      function iB(t, e) {
        let r = iN({ encoded: t, encoding: e?.encoding });
        return iC({
          type: iw(r.type),
          senderPublicKey:
            "u" > typeof r.senderPublicKey
              ? (0, b.BB)(r.senderPublicKey, ih)
              : void 0,
      ...
      function iR(t, e) {
        ...
        let f = o.slice(0, 32).toString("hex"),
          ...
          u = `${r}.${i}`,
          h = new g.mE().update(M.from(u)).digest(),
        ...
        if (!a.verify(l, { r: f, s: s })) throw Error("Invalid signature");
      ...
      var iU = Object.defineProperty,
        ...
        iz = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        ij = (t, e) => {
          for (var r in e || (e = {})) iL.call(e, r) && iz(t, r, e[r]);
          if (iF) for (var r of iF(e)) iq.call(e, r) && iz(t, r, e[r]);
          return t;
        },
        iH = (t, e) => iT(t, iD(e));
      function iK(t) {
      ...
      function i3(t, e) {
        ...
        for (let [e, i] of Object.entries(r))
          i.methods ? (i.methods = $(i.methods, t)) : (i.methods = t),
      ...
      function i5(t, e) {
        let { message: r, code: i } = i8[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function i4(t, e) {
        let { message: r, code: i } = i6[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function i9(t, e) {
        return (
      ...
      function ne(t, e) {
        return !!(e && nt(t)) || ("string" == typeof t && !!t.trim().length);
      }
      function nr(t, e) {
        return !!(e && nt(t)) || ("number" == typeof t && !isNaN(t));
      }
      function ni(t, e) {
        ...
        return (
          !!z(n, i) &&
          (i.forEach((e) => {
            let { accounts: i, methods: n, events: f } = t.namespaces[e],
              s = i0(i),
              u = r[e];
            (z(S(e, u), s) && z(u.methods, n) && z(u.events, f)) || (o = !1);
          }),
          o)
        );
      }
      function nn(t) {
        return !!(ne(t, !1) && t.includes(":")) && 2 === t.split(":").length;
      }
      function no(t) {
        function e(t) {
          try {
      ...
      function nh(t) {
        let e = !0;
        return (
          i9(t) ? t.length && (e = t.every((t) => ne(t, !1))) : (e = !1), e
        );
      }
      function na(t, e) {
        let r = null;
                ...
                i9(o) && o.length
                  ? o.forEach((t) => {
                      s ||
                        ...
                        (s = i4(
                          "UNSUPPORTED_CHAINS",
                          `${f}, chain ${t} should be a string and conform to "namespace:chainId" format`
                        ));
                    })
                  : nn(t) ||
                    (s = i4(
                      "UNSUPPORTED_CHAINS",
                      `${f}, chains must be defined as "namespace:chainId" e.g. "eip155:1": {...} in the namespace key OR as an array of CAIP-2 chainIds e.g. eip155: { chains: ["eip155:1", "eip155:5"] }`
                    )),
                s);
              u && (n = u);
            }),
      ...
      function nb(t) {
        return !(nt(t) || !ne(t.method, !1));
      }
      function nA(t) {
        return !(
          nt(t) ||
          (nt(t.result) && nt(t.error)) ||
          !nr(t.id, !1) ||
          !ne(t.jsonrpc, !1)
        );
      }
      function ny(t) {
        return !(nt(t) || !ne(t.name, !1));
      }
      function nw(t, e) {
        return !(
          !nn(e) ||
      ...
      function nx(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                i0(t.accounts).includes(e) && r.push(...t.methods);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      function nM(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                i0(t.accounts).includes(e) && r.push(...t.events);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      Approved: ${s.toString()}`
        ...
        Approved: ${n.toString()}`
          ...
          f.forEach((t) => {
            i ||
              (z(n[t].methods, o[t].methods)
                ? z(n[t].events, o[t].events) ||
                  (i = i5(
                    "NON_CONFORMING_NAMESPACES",
      ...
      async function nB() {
        if (k() && "u" > typeof r.g && null != r.g && r.g.NetInfo) {
