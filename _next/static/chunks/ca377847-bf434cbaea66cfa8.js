  ...
  [674],
  {
    55211: (t, e, i) => {
      ...
      class y {
        ...
        buildOrUpdateElements(t) {
          ...
          (e._stacked = g(e.vScale, e)),
            ...
            (s || a !== e._stacked) &&
              (f(this, e._parsed), (e._stacked = g(e.vScale, e)));
        }
        configure() {
        ...
        _calculateBarValuePixels(t) {
          ...
          if (
            ...
            let t = a.getPixelForDecimal(0),
              ...
              c = Math.min(t, o);
            (e = (x = Math.max(Math.min(x, Math.max(t, o)), c)) + i),
              n &&
                !u &&
      ...
      class L extends y {
        ...
        update(t) {
          let { chartArea: e } = this.chart,
            ...
            f = Math.max(
              Math.min((e.width - n) / c, (e.height - n) / u) / 2,
              0
            ),
            m = (0, s.n)(this.options.radius, f),
            x = Math.max(m * o, 0),
            b = (m - x) / this._getVisibleDatasetWeightTotal();
          (this.offsetX = g * m),
            (this.offsetY = p * m),
            (i.total = this.calculateTotal()),
            (this.outerRadius = m - b * this._getRingWeightOffset(this.index)),
            (this.innerRadius = Math.max(this.outerRadius - b * l, 0)),
      ...
      function tg(t, e, i) {
        ...
        return a && a.addEventListener(e, n, ta), n;
      }
      class tp extends Z {
        acquireContext(t, e) {
        ...
        removeEventListener(t, e) {
          ...
          s &&
            ((
              ...
              function (t, e, i) {
                t && t.canvas && t.canvas.removeEventListener(e, i, ta);
              }
            )(t, e, s),
            (i[e] = void 0));
        }
      ...
      class tV {
        constructor(t) {
          (this._config = (function (t) {
            return ((t = t || {}).data = tT(t.data)), tA(t), t;
          })(t)),
      ...
      class eg extends tf {
        ...
        fit() {
          ...
          let n = i.labels,
            ...
            { boxWidth: h, itemHeight: d } = ec(n, o);
          (a.font = r.string),
            this.isHorizontal()
        ...
        _draw() {
          ...
          this.drawTitle(),
            ...
            (n.lineWidth = 0.5),
            (n.font = d.string);
          let { boxWidth: p, boxHeight: f, itemHeight: m } = ec(o, u),
            x = function (t, e, i) {
      ...
      var ef = {
        ...
        _element: eg,
        start(t, e, i) {
          let s = (t.legend = new eg({ ctx: t.ctx, options: i, chart: t }));
      ...
      var ex = {
        ...
        start(t, e, i) {
          !(function (t, e) {
            let i = new em({ ctx: t.ctx, options: e, chart: t });
      ...
      function eP(t, e, i, s) {
        let a = t[e].call(i, s);
        return void 0 === a ? eD[e].call(i, s) : a;
      }
      class eC extends tf {
        static positioners = eb;
        constructor(t) {
          super(),
            (this.opacity = 0),
            (this._active = []),
        ...
        getTitle(t, e) {
          let { callbacks: i } = e,
            s = eP(i, "beforeTitle", this, t),
            a = eP(i, "title", this, t),
            n = eP(i, "afterTitle", this, t),
            r = [];
          return (r = e_(r, ev(s))), (r = e_(r, ev(a))), (r = e_(r, ev(n)));
        }
        getBeforeBody(t, e) {
          return e_([], ev(eP(e.callbacks, "beforeBody", this, t)));
        }
        getBody(t, e) {
          let { callbacks: i } = e,
            a = [];
          return (
            (0, s.F)(t, (t) => {
              let e = { before: [], lines: [], after: [] },
                s = eS(i, t);
              e_(e.before, ev(eP(s, "beforeLabel", this, t))),
                e_(e.lines, eP(s, "label", this, t)),
                e_(e.after, ev(eP(s, "afterLabel", this, t))),
                a.push(e);
            }),
            a
          );
        ...
        getAfterBody(t, e) {
          return e_([], ev(eP(e.callbacks, "afterBody", this, t)));
        }
        getFooter(t, e) {
          let { callbacks: i } = e,
            s = eP(i, "beforeFooter", this, t),
            a = eP(i, "footer", this, t),
            n = eP(i, "afterFooter", this, t),
            r = [];
          return (r = e_(r, ev(s))), (r = e_(r, ev(a))), (r = e_(r, ev(n)));
        }
        _createItems(t) {
          ...
          return (
            ...
            (0, s.F)(h, (e) => {
              let i = eS(t.callbacks, e);
              r.push(eP(i, "labelColor", this, e)),
                o.push(eP(i, "labelPointStyle", this, e)),
                l.push(eP(i, "labelTextColor", this, e));
            }),
            (this.labelColors = r),
        ...
        update(t, e) {
          ...
          let s = this.options.setContext(this.getContext()),
            ...
            n = [];
          if (a.length) {
            let t = eb[s.position].call(this, a, this._eventPosition);
            ...
            let e = (this._size = ey(this, s)),
              r = Object.assign({}, t, e),
              o = eM(this.chart, s, r),
              l = ew(s, r, o, this.chart);
        ...
        _updateAnimationTarget(t) {
          let e = this.chart,
            ...
            a = i && i.y;
          if (s || a) {
            let i = eb[t.position].call(
              this,
              this._active,
              this._eventPosition
            );
            if (!i) return;
            let n = (this._size = ey(this, t)),
      ...
      var eL = {
        ...
        positioners: eb,
        afterInit(t, e, i) {
          i && (t.tooltip = new eC({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
      ...
      let eE = (t, e, i, s) => (
        ...
        eO = (t, e) => (null === t ? null : (0, s.S)(Math.round(t), 0, e));
      function eA(t) {
      ...
      class eT extends tw {
        static id = "category";
        static defaults = { ticks: { callback: eA } };
        constructor(t) {
          super(t),
      ...
      function eF(t, e, { horizontal: i, minRotation: a }) {
        let n = (0, s.t)(a),
        ...
        buildTicks() {
          let t = this.options,
            ...
            a = (function (t, e) {
              ...
              return (
                M && m && n !== c
                  ? o.length && (0, s.aJ)(o[o.length - 1].value, c, eF(c, k, t))
      ...
      let eI = (t) => Math.floor((0, s.aM)(t)),
        eV = (t, e) => Math.pow(10, eI(t) + e);
      function eB(t) {
        return 1 == t / Math.pow(10, eI(t));
      }
      function eN(t, e, i) {
        let s = Math.pow(10, i),
          a = Math.floor(t / s);
      ...
      class eH extends tw {
        ...
        parse(t, e) {
          let i = ez.prototype.parse.apply(this, [t, e]);
          if (0 === i) {
            this._zero = !0;
            return;
          }
        ...
        determineDataLimits() {
          ...
          (this.min = (0, s.g)(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
              ...
              !(0, s.g)(this._userMin) &&
              (this.min =
                t === eV(this.min, 0) ? eV(this.min, -1) : eV(this.min, 0)),
            this.handleTickRangeOptions();
        }
        handleTickRangeOptions() {
          let { minDefined: t, maxDefined: e } = this.getUserBounds(),
            ...
            a = (e) => (i = t ? i : e),
            n = (t) => (s = e ? s : t);
          i === s && (i <= 0 ? (a(1), n(10)) : (a(eV(i, -1)), n(eV(s, 1)))),
            i <= 0 && a(eV(s, -1)),
            s <= 0 && n(eV(i, 1)),
            (this.min = i),
            (this.max = s);
        ...
        buildTicks() {
          let t = this.options,
            e = (function (t, { min: e, max: i }) {
              ...
              for (; g < i; )
                a.push({ value: g, major: eB(g), significand: u }),
                  u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
                  u >= 20 && ((u = 2), (o = ++r >= 0 ? 1 : o)),
                  (g = Math.round((h + c + u * Math.pow(10, r)) * o) / o);
              let p = (0, s.O)(t.max, g);
              return a.push({ value: p, major: eB(p), significand: u }), a;
      ...
      class eU extends ez {
        ...
        setDimensions() {
          let t = (this._padding = (0, s.E)(eW(this.options) / 2)),
        ...
        computeTickLimit() {
          return Math.ceil(this.drawingArea / eW(this.options));
        }
        generateTickLabels(t) {
          ez.prototype.generateTickLabels.call(this, t),
      ...
      function eG(t, e, i, s) {
        let a = eQ.length;
        for (let n = eQ.indexOf(t); n < a - 1; ++n) {
          let t = eY[eQ[n]],
            a = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
          if (t.common && Math.ceil((i - e) / (a * t.size)) <= s) return eQ[n];
        }
        return eQ[a - 1];
      }
      function eK(t, e, i) {
      ...
      class eZ extends tw {
        ...
        buildTicks() {
          ...
          return (
            (this._unit =
              e.unit ||
              (i.autoSkip
                ? eG(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
                : (function (t, e, i, s, a) {
                    for (let n = eQ.length - 1; n >= eQ.indexOf(i); n--) {
                      let i = eQ[n];
                      if (eY[i].common && t._adapter.diff(a, s, i) >= e - 1)
                        return i;
                    }
                    return eQ[i ? eQ.indexOf(i) : 0];
                  })(this, o.length, e.minUnit, this.min, this.max))),
            (this._majorUnit =
              i.major.enabled && "year" !== this._unit
                ? (function (t) {
                    for (let e = eQ.indexOf(t) + 1, i = eQ.length; e < i; ++e)
                      if (eY[eQ[e]].common) return eQ[e];
                  })(this._unit)
                : void 0),
            this.initOffsets(a),
            t.reverse && o.reverse(),
            eJ(this, o, this._majorUnit)
          );
        }
        afterAutoSkip() {
        ...
        _generate() {
          ...
          let i = this._adapter,
            ...
            r = this.options,
            o = r.time,
            l = o.unit || eG(o.minUnit, a, n, this._getLabelCapacity(a)),
          ...
          for (t = g, e = 0; t < n; t = +i.add(t, h, l), e++) eK(u, t, p);
          return (
            (t === n || "ticks" === r.bounds || 1 === e) && eK(u, t, p),
            Object.keys(u)
              .sort(eX)
              .map((t) => +t)
          );
      ...
      class e1 extends eZ {
        ...
        initOffsets() {
          ...
          (this._minPos = e0(e, this.min)),
            (this._tableRange = e0(e, this.max) - this._minPos),
            super.initOffsets(t);
        }
        buildLookupTable(t) {
          let e, i, s;
        ...
        getDecimalForValue(t) {
          return (e0(this._table, t) - this._minPos) / this._tableRange;
        }
        getValueForPixel(t) {
          let e = this._offsets,
            i = this.getDecimalForPixel(t) / e.factor - e.end;
          return e0(this._table, i * this._tableRange + this._minPos, !0);
        }
      }
    },
  },
